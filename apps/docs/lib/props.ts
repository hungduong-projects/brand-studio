...
const sources = ['core.tsx', 'ai.tsx', 'effects.tsx', 'app.tsx', 'nav.tsx', 'data.tsx', 'story.tsx', 'chat.tsx', 'voice.tsx'].map(file => readFileSync(path.join(sourceDir, file), 'utf8')).join('\n');
