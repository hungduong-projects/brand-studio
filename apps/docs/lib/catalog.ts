...
export const catalog: Entry[] = [
  ...
  { slug: 'lightbox', exports: ['Lightbox'], title: 'Lightbox', category: 'Storytelling', description: 'A grid of thumbnails. Each one grows into a full-screen view you can step or swipe through.' },
